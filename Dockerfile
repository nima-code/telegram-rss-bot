...
# ساخت پوشه‌ها و تنظیم دسترسی‌ها
RUN mkdir -p /app/public /app/public/images /app/routes /etc/nginx /var/log/nginx /var/log/supervisor /var/run /app/storage /app/storage/logs /app/storage/feeds \
    && chown -R www-data:www-data /app/public /app/public/images /app/routes /etc/nginx /var/log/nginx /var/log/supervisor /var/run /app/storage /app/storage/logs /app/storage/feeds \
    && chmod -R 775 /app/public /app/public/images /app/routes /etc/nginx /var/log/nginx /var/log/supervisor /var/run /app/storage /app/storage/logs /app/storage/feeds \
    ...
    && echo "Creating feeds and images directories and setting permissions" \
    && mkdir -p /app/storage/feeds /app/public/images \
    && chown -R www-data:www-data /app/storage/feeds /app/public/images \
    && chmod -R 775 /app/storage/feeds /app/public/images \
    && ls -la /app/storage /app/storage/feeds /app/public/images || { echo "Directory creation failed"; exit 1; } \
    && echo "Checking storage permissions" \
    && touch /app/storage/feeds/test.json && rm /app/storage/feeds/test.json || { echo "Storage write test failed"; exit 1; } \
    && (test -f /app/.env || { echo "Creating default .env"; echo -e "APP_NAME=LumenRSSBot\nAPP_ENV=production\nAPP_KEY=$(php -r 'echo base64_encode(random_bytes(32));')\nAPP_DEBUG=false\nTELEGRAM_BOT_TOKEN=7648771268:AAE4Hxioz8tTod0vmm8ajN4Pdz4ikQ0ktbg\nTELEGRAM_MODE=webhook\nAPP_URL=https://telegram-rss-bot-kmgj.onrender.com" > /app/.env; }) \
